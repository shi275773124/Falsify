...
.deliverables{display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-top:24px}.artifact{border:1px solid var(--border);border-radius:14px;background:#0d0d0d;overflow:hidden}.artifact-head{display:flex;align-items:center;justify-content:space-between;padding:12px 16px;border-bottom:1px solid var(--border);font:600 12px var(--mono);color:var(--muted)}.artifact-body{padding:16px;font:12px/1.65 var(--mono);color:#c9d2de;white-space:pre-wrap}.pr-mock{padding:16px;font-size:14px;line-height:1.55}.pr-mock .pr-title{font-weight:700;margin-bottom:10px}.pr-mock .pr-line{margin:8px 0;padding:10px 12px;border-left:3px solid var(--block);background:rgba(255,92,92,.06);border-radius:0 8px 8px 0}
...
}</div></div><div class="artifact"><div class="artifact-head"><span data-i18n="deliver_pr_label">PR comment</span><span>GitHub Check</span></div><div class="artifact-body pr-mock"><div class="pr-title" data-i18n="deliver_pr_title">Falsify review — BLOCK</div><div class="pr-line" data-i18n="deliver_pr_line">Must Fix: deployment claim cites logs only. Attach post-deploy state proof.</div></div></div></div></div></section>
