...
.nav{position:sticky;top:0;z-index:30;background:rgba(9,9,9,.88);backdrop-filter:blur(14px);border-bottom:1px solid var(--border)}.nav .wrap{display:flex;align-items:center;justify-content:space-between;height:64px;gap:16px}.brand{font:800 18px/1 var(--font);letter-spacing:-.02em;color:var(--fg)}.links{display:flex;align-items:center;gap:20px;color:var(--muted);font-size:14px;font-weight:500}.links a:hover{color:var(--fg)}.lang-btn{background:transparent;border:1px solid var(--border);border-radius:999px;color:var(--muted);cursor:pointer;font:600 12px var(--mono);padding:6px 12px}.lang-btn:hover{border-color:var(--fg);color:var(--fg)}
...
.hero{position:relative;overflow:hidden;border-bottom:1px solid var(--border)}.hero-inner{display:grid;grid-template-columns:1.1fr .9fr;min-height:min(88vh,760px)}.hero-copy{padding:clamp(88px,12vw,140px) var(--pad) 64px;max-width:640px;margin-left:max(0px,calc((100vw - var(--max))/2))}.hero-visual{position:relative;background:var(--bg-panel);border-left:1px solid var(--border);clip-path:polygon(18% 0,100% 0,100% 100%,0 100%)}.hero-visual-inner{position:absolute;inset:32px 32px 32px 14%;display:flex;flex-direction:column;justify-content:center;gap:12px}.preview-card{background:var(--bg-elevated);border:1px solid var(--border);border-radius:14px;padding:0;box-shadow:0 16px 48px rgba(0,0,0,.55);max-width:340px;overflow:hidden}.preview-bar{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:10px 14px;border-bottom:1px solid var(--border);background:rgba(255,92,92,.06)}.preview-label{font:600 11px var(--mono);letter-spacing:.08em;text-transform:uppercase;color:var(--muted)}.preview-body{padding:14px}.preview-title{font:600 15px/1.4 var(--font);margin:0 0 12px;color:var(--fg)}.preview-schema{font:10px var(--mono);color:var(--muted);opacity:.75;margin-bottom:10px}.preview-must-fix{padding:10px 12px;border-radius:8px;background:rgba(255,92,92,.08);border:1px solid rgba(255,92,92,.2);font:12px/1.5 var(--mono);color:var(--body)}.preview-must-fix strong{display:block;color:var(--block);font-size:10px;letter-spacing:.06em;text-transform:uppercase;margin-bottom:4px}.preview-action{display:block;margin-top:6px;color:var(--muted);font-size:11px}.hero-chips{display:flex;flex-wrap:wrap;gap:8px;margin-bottom:18px}.hero-chip{display:inline-flex;align-items:center;padding:5px 11px;border:1px solid rgba(184,255,60,.2);border-radius:999px;color:var(--muted);font:600 11px var(--mono);letter-spacing:.04em;background:rgba(184,255,60,.04)}.hero-chip::before{content:"";width:4px;height:4px;border-radius:50%;background:var(--accent);margin-right:7px;opacity:.75;flex-shrink:0}.trust-strip{display:flex;flex-wrap:wrap;gap:8px;margin-top:14px}.trust-badge{display:inline-flex;align-items:center;padding:6px 11px;border:1px solid var(--border);border-radius:6px;color:var(--muted);font:600 11px var(--mono);letter-spacing:.03em;background:rgba(255,255,255,.02)}.trust-badge::before{content:"";width:5px;height:5px;border-radius:1px;background:var(--accent);margin-right:7px;opacity:.55;flex-shrink:0}.eyebrow{font:600 12px var(--mono);letter-spacing:.12em;text-transform:uppercase;color:var(--accent);margin-bottom:16px}h1{margin:0 0 16px;font-size:clamp(40px,6vw,68px);line-height:.95;letter-spacing:-.03em;font-weight:800;color:var(--fg)}.sub{margin:0 0 28px;color:var(--body);font-size:clamp(17px,2.2vw,20px);line-height:1.5;max-width:52ch}.hero-sub-note{font-size:13px;color:var(--muted);margin:-12px 0 28px;max-width:52ch}.actions{display:flex;flex-wrap:wrap;gap:14px;margin-bottom:28px}.hero-meta{display:flex;flex-wrap:wrap;gap:10px}.pill{display:inline-flex;align-items:center;gap:8px;padding:8px 12px;border:1px solid var(--border);border-radius:999px;color:var(--muted);font:600 13px var(--mono)}
...
<header class="hero"><div class="hero-inner"><div class="hero-copy"><h1 data-i18n="h1">Looks right is not enough.</h1><div class="hero-chips" role="list" aria-label="Product scope"><span class="hero-chip" role="listitem" data-i18n="hero_chip_1">Frame Audit</span><span class="hero-chip" role="listitem" data-i18n="hero_chip_2">Adversarial Review</span><span class="hero-chip" role="listitem" data-i18n="hero_chip_3">Cutline</span></div><p class="sub" data-i18n="hero_sub">Falsify turns confident AI output into a shipping decision:<br>PASS, PASS_WITH_DEBT, or BLOCK — backed by raw evidence.</p><p class="hero-sub-note" data-i18n="hero_sub_note">For PRs, deployment claims, research memos, and AI-generated decisions.</p><p class="hero-sub-note" data-i18n="hero_definition">Full Falsify = Frame Audit + Adversarial Review + Cutline. Miss a layer, you only have a partial review.</p><p class="hero-sub-note" data-i18n="hero_workbench_note">Protocol is three-layer. The public workbench below shows verdict format and adversarial samples — not machine-enforced Frame Audit or Cutline.</p><div class="actions"><a class="btn primary" href="/docs/14-github-action-install.md" data-i18n="btn_install">Install GitHub Action</a><a class="btn ghost" href="#demo" data-i18n="btn_run_sample_hero">Run sample</a></div><div class="hero-meta"><span class="pill" data-i18n="pill_verdicts">PASS / PASS_WITH_DEBT / BLOCK</span><span class="pill" data-i18n="pill_stack">backed by raw evidence</span></div><div class="trust-strip" aria-label="Trust signals"><span class="trust-badge" data-i18n="trust_github">GitHub Actions</span><span class="trust-badge" data-i18n="trust_mit">MIT (core)</span><span class="trust-badge" data-i18n="trust_byok">BYOK</span><span class="trust-badge" data-i18n="trust_schema">falsify.review.v1</span></div></div><div class="hero-visual" aria-hidden="true"><div class="hero-visual-inner"><div class="preview-card"><div class="preview-bar"><span class="preview-label" data-i18n="preview_label">Review output</span><span class="badge BLOCK">BLOCK</span></div><div class="preview-body"><div class="preview-schema">falsify.review.v1 · reports/deploy.md</div><div class="preview-title" data-i18n="preview_title">Deployment succeeded because logs completed.</div><div class="preview-must-fix"><strong data-i18n="preview_must_fix">Must Fix</strong><span data-i18n="preview_issue">Logs are treated as state verification</span><span class="preview-action" data-i18n="preview_action">Minimal action: Add read-after-write probe</span></div></div></div></div></div></div></header>
...
<section class="evidence"><div class="wrap"><div class="evidence-grid"><div class="evidence-card"><div class="evidence-tag" data-i18n="ev1_tag">Speed</div><div class="evidence-val" data-i18n="ev1_val">&lt; 1 day</div><div class="evidence-lbl" data-i18n="ev1_lbl">Time to first useful BLOCK</div></div><div class="evidence-card"><div class="evidence-tag" data-i18n="ev2_tag">Verdicts</div><div class="evidence-val" data-i18n="ev2_val">3 verdicts</div><div class="evidence-lbl" data-i18n="ev2_lbl">PASS / PASS_WITH_DEBT / BLOCK only</div></div><div class="evidence-card"><div class="evidence-tag" data-i18n="ev3_tag">Strict mode</div><div class="evidence-val" data-i18n="ev3_val">100%</div><div class="evidence-lbl" data-i18n="ev3_lbl">Known Debt requires upgrade trigger (strict mode)</div></div></div></div></section>
...
const T={en:{"nav_system":"System","nav_demo":"Demo","nav_pricing":"Pricing","nav_docs":"Docs","h1":"Looks right is not enough.","hero_chip_1":"Frame Audit","hero_chip_2":"Adversarial Review","hero_chip_3":"Cutline","hero_sub":"Falsify turns confident AI output into a shipping decision:\nPASS, PASS_WITH_DEBT, or BLOCK — backed by raw evidence.","hero_sub_note":"For PRs, deployment claims, research memos, and AI-generated decisions.","hero_definition":"Full Falsify = Frame Audit + Adversarial Review + Cutline. Miss a layer, you only have a partial review.","hero_workbench_note":"Protocol is three-layer. The public workbench below shows verdict format and adversarial samples — not machine-enforced Frame Audit or Cutline.","btn_install":"Install GitHub Action","btn_run_sample_hero":"Run sample","btn_sample_report":"View deliverables","btn_demo":"Try demo","btn_audit":"Book audit","pill_verdicts":"PASS / PASS_WITH_DEBT / BLOCK","pill_stack":"backed by raw evidence","trust_github":"GitHub Actions","trust_mit":"MIT (core)","trust_byok":"BYOK","trust_schema":"falsify.review.v1","preview_label":"Review output","preview_title":"Deployment succeeded because logs completed.","preview_must_fix":"Must Fix","preview_issue":"Logs are treated as state verification","preview_action":"Minimal action: Add read-after-write probe","quote_p":"\"Green logs aren't proof. We stopped pretending they were.\"","quote_cite":"Chris Shi","hero_layers_hook":"AI made fake proof cheap.","hero_layers_intro":"Falsify runs three layers.","hero_layers_l1_tag":"Frame","hero_layers_l1_map":"Frame Audit","hero_layers_l1_body":"hidden state, authority drift, missing rollback.","hero_layers_l2_tag":"Evidence","hero_layers_l2_map":"Adversarial Review","hero_layers_l2_body":"false facts, fake acceptance, audit theater.","hero_layers_l3_tag":"Cutline","hero_layers_l3_map":"Cutline","hero_layers_l3_body":"must fix, known debt, delete.","hero_layers_close":"Three verdicts only.","hero_layers_verdicts":"PASS / PASS_WITH_DEBT / BLOCK","ev1_tag":"Speed","ev1_val":"< 1 day","ev1_lbl":"Time to first useful BLOCK","ev2_tag":"Verdicts","ev2_val":"3 verdicts","ev2_lbl":"PASS / PASS_WITH_DEBT / BLOCK only","ev3_tag":"Strict mode","ev3_val":"100%","ev3_lbl":"Known Debt requires upgrade trigger (strict mode)","deliver_tag":"Deliverables","deliver_h2":"What you actually ship.","deliver_lead":"Not another chat reply — a PR check, a JSON report, and a markdown summary your team can defend.","deliver_pr_label":"Pull request check","deliver_pr_check_failed":"Failed","deliver_pr_check_name":"falsify-pr-review","deliver_pr_check_sub":"falsify / test-suite","deliver_pr_bot":"github-actions[bot]","deliver_pr_commented":"commented","deliver_pr_verdict":"Falsify Verdict: BLOCK","deliver_pr_filepath":"reports/deploy.md","deliver_pr_lint":"lint: ✅","deliver_pr_review":"review:","deliver_pr_must_fix":"Must Fix","deliver_pr_issue":"Logs are treated as state verification","deliver_pr_action":"Minimal action: Add read-after-write probe","deliver_pr_final_h":"Final","deliver_pr_final":"Merge blocked until Must Fix items are resolved.","problem_tag":"Problem","problem_h2":"Confidence got cheap.","problem_lead":"AI made teams faster. It also made polished wrongness easier to ship.","p1":"Green logs that do not prove state","p2":"Second-model agreement treated as proof","p3":"Safety checks that live only in prompts","system_tag":"System","system_h2":"Three layers. One decision.","system_lead":"Frame Audit, Adversarial Review, and Cutline — built for teams that cannot afford fake PASS.","bl_label":"Layer 01","ar_label":"Layer 02","rs_label":"Layer 03","bl_h3":"Frame Audit","ar_h3":"Adversarial Review","rs_h3":"Cutline","bl_1":"hidden state / implicit authority","bl_2":"owner / lock / lifecycle","bl_4":"rollback / verification path","ar_1":"false truth / false risk","ar_5":"prompt-only audit theater","ar_6":"monitor-failure laundering","rs_1":"Must Fix","rs_2":"Known Debt","rs_3":"Delete","rs_lead":"Decides what blocks now — not a laundry list of every risk.","compare_tag":"Fake proof","compare_h2":"Fake proof is not proof.","cmp_l1":"\"The model said it is fine.\"","cmp_r1":"Where is the raw artifact.","cmp_l2":"\"Another AI reviewed it.\"","cmp_r2":"Did it check the failure mode, or just agree.","cmp_l3":"\"The logs look successful.\"","cmp_r3":"Did the actual state change.","antipattern_tag":"Not Falsify","antipattern_h2":"Looks like review. Is not full Falsify.","antipattern_lead":"Partial checks masquerade as complete review.","ap_1":"\"A second glance\" ≠ full Falsify","ap_2":"Cutline-only ≠ full Falsify","ap_3":"Every smell as Must Fix ≠ Cutline","try_tag":"Workbench","try_h2":"See a verdict in seconds.","try_lead":"Preview verdict format here. Samples are fixed adversarial demos; live review is one LLM call with your local key — not full Falsify.","input_h3":"Claim","input_p":"Paste a deployment claim, PR summary, or AI-generated report.","output_h3":"Verdict","output_p":"Hit Run sample to preview the decision artifact.","demo_note":"Partial layer only. Canned samples are adversarial demos — not full Falsify. Live /review is a single LLM pass with your local key; no Frame Audit gate, no machine Cutline.","workbench_scope":"Full stack: CLI + GitHub Action. This page demonstrates output shape, not enforcement.","scenario_general":"General","scenario_code":"Code / PR","scenario_research":"Research","scenario_production":"Production","btn_sample":"Run sample","btn_review":"Live review","pricing_tag":"Pricing","pricing_h2":"Start free. Scale with your team.","pricing_lead":"Protocol, CLI, and templates are MIT open core. Team is hosted governance, retention, and org rollout — not the protocol itself.","price_free_limit":"Self-hosted · unlimited repos · BYOK","price_free_who":"For solo builders trying the protocol","price_free_1":"CLI + MIT core","price_free_2":"Local review with your API key","price_free_3":"OSS templates + Action gate","price_team_limit":"Up to 10 repos · hosted workspace · 90-day retention","price_team_who":"For tech leads gating AI-generated PRs","price_team_1":"Hosted org policy & retention","price_team_2":"Org rollout & governance controls","price_team_3":"Managed GitHub App (reserved)","btn_waitlist":"Join waitlist","price_ent_label":"Custom","price_ent_limit":"SSO/RBAC · private deploy · SLA + audit coaching","price_ent_who":"For orgs needing private deploy + coaching","price_ent_1":"Private deploy","price_ent_2":"Workflow integration","price_ent_3":"Audit coaching","start_tag":"Start","start_h2":"Run it locally in 60 seconds.","docs_install":"Install GitHub Action (5 min) →","boundary_tag":"Boundary","boundary_h2":"Falsify classifies risk. It does not authorize action.","boundary_p":"Live money, production config, cron, gateway, and external send still require independent final judgment. Self-review is not independent review.","licensing_tag":"Open core","licensing_h2":"What is open vs Team.","licensing_p":"MIT covers the protocol, CLI, JSON schema, workflow templates, and local artifacts. Team covers hosted policy enforcement, report retention, org rollout, and managed integrations — not a second copy of the OSS templates.","lic_open_1":"Protocol + CLI + templates","lic_open_2":"MIT — self-hosted, unlimited repos","lic_team_1":"Hosted governance + retention","lic_team_2":"Team — org workspace, not OSS overlap","licensing_link":"Read the full open core boundary →","btn_github":"GitHub"},
zh:{"nav_system":"系统","nav_demo":"演示","nav_pricing":"定价","nav_docs":"文档","h1":"看起来对，不够。","hero_chip_1":"框架审","hero_chip_2":"对抗审","hero_chip_3":"Cutline","hero_sub":"Falsify 把 AI 的自信输出变成上线决策：\nPASS、PASS_WITH_DEBT、BLOCK — 以原始证据为准。","hero_sub_note":"覆盖 PR、部署声明、研究备忘录、AI 生成决策。","hero_definition":"完整 Falsify = 框架审 + 对抗审 + Cutline；缺任一层，只是局部审查。","hero_workbench_note":"协议是三层。下方公网工作台只演示裁决格式与对抗审样例 — 非机审框架审，非机审 Cutline。","btn_install":"安装 GitHub Action","btn_run_sample_hero":"运行样例","btn_sample_report":"查看交付物","btn_demo":"试用演示","btn_audit":"预约审计","pill_verdicts":"PASS / PASS_WITH_DEBT / BLOCK","pill_stack":"以原始证据为准","trust_github":"GitHub Actions","trust_mit":"MIT（核心）","trust_byok":"BYOK","trust_schema":"falsify.review.v1","preview_label":"审查输出","preview_title":"部署成功，因为日志跑完了。","preview_must_fix":"Must Fix","preview_issue":"日志被当作状态验证","preview_action":"最小动作：添加 read-after-write 探针","quote_p":"「日志绿了，不等于证据成立。我们不再假装它算数。」","quote_cite":"史可鉴","hero_layers_hook":"AI 让假证明变便宜了。","hero_layers_intro":"Falsify 走三层。","hero_layers_l1_tag":"审结构","hero_layers_l1_map":"框架审","hero_layers_l1_body":"隐式状态、越权路径、回滚缺失。","hero_layers_l2_tag":"审证据","hero_layers_l2_map":"对抗审","hero_layers_l2_body":"假事实、假验收、审计作秀。","hero_layers_l3_tag":"裁边界","hero_layers_l3_map":"Cutline","hero_layers_l3_body":"必须修、可以欠、该删。","hero_layers_close":"走完，只落三档裁决。","hero_layers_verdicts":"PASS / PASS_WITH_DEBT / BLOCK","ev1_tag":"速度","ev1_val":"< 1 天","ev1_lbl":"首次有效 BLOCK","ev2_tag":"裁决","ev2_val":"3 种裁决","ev2_lbl":"仅 PASS / PASS_WITH_DEBT / BLOCK","ev3_tag":"严格模式","ev3_val":"100%","ev3_lbl":"Known Debt 必须带升级触发（严格模式）","deliver_tag":"交付物","deliver_h2":"你真正交付的是什么","deliver_lead":"不是又一条聊天回复 — 而是 PR Check、JSON 报告、站得住脚的 Markdown 摘要。","deliver_pr_label":"PR 检查","deliver_pr_check_failed":"失败","deliver_pr_check_name":"falsify-pr-review","deliver_pr_check_sub":"falsify / test-suite","deliver_pr_bot":"github-actions[bot]","deliver_pr_commented":"评论于","deliver_pr_verdict":"Falsify Verdict: BLOCK","deliver_pr_filepath":"reports/deploy.md","deliver_pr_lint":"lint: ✅","deliver_pr_review":"review:","deliver_pr_must_fix":"Must Fix","deliver_pr_issue":"日志被当作状态验证","deliver_pr_action":"最小动作：添加 read-after-write 探针","deliver_pr_final_h":"Final","deliver_pr_final":"Must Fix 未解决，合并阻断。","problem_tag":"问题","problem_h2":"自信变便宜了。","problem_lead":"AI 让交付变快，也让漂亮的错误更容易上线。","p1":"日志绿了，不代表状态对了","p2":"第二个模型点头，不代表证据成立","p3":"安全检查只写在提示词里","system_tag":"系统","system_h2":"三层结构，一个决策。","system_lead":"框架审、对抗审、Cutline — 给承受不起假 PASS 的团队。","bl_label":"第一层","ar_label":"第二层","rs_label":"第三层","bl_h3":"框架审","ar_h3":"对抗审","rs_h3":"Cutline","bl_1":"隐藏状态与隐式授权","bl_2":"归属、锁与生命周期","bl_4":"回滚与验证路径","ar_1":"虚假事实与虚假风险","ar_5":"提示词作秀","ar_6":"监控洗白","rs_1":"Must Fix","rs_2":"Known Debt","rs_3":"Delete","rs_lead":"决定当下什么阻塞，不是罗列全部风险。","compare_tag":"假证明","compare_h2":"假证明不是证明。","cmp_l1":"\"模型说没问题。\"","cmp_r1":"原始输出在哪。","cmp_l2":"\"另一个 AI 审过了。\"","cmp_r2":"它查了失败模式，还是只是附和。","cmp_l3":"\"日志看起来成功。\"","cmp_r3":"实际状态变了吗。","antipattern_tag":"不是 Falsify","antipattern_h2":"像审查，不是完整 Falsify。","antipattern_lead":"局部检查冒充完整审查。","ap_1":"「再看一眼」≠ 完整 Falsify","ap_2":"只有 Cutline ≠ 完整 Falsify","ap_3":"每个 smell 都是 Must Fix ≠ Cutline","try_tag":"工作台","try_h2":"几秒内看到裁决。","try_lead":"在此预览裁决格式。样例为固定对抗审样例；真审查为单次模型调用、本地 key — 不是完整 Falsify。","input_h3":"声明","input_p":"粘贴部署声明、PR 摘要或 AI 生成报告。","output_h3":"裁决","output_p":"点「运行样例」预览裁决。","demo_note":"局部层演示。样例为固定对抗审样例，不是完整 Falsify。真 /review 为单次模型调用、本地 key；无框架审闸门，无机审 Cutline。","workbench_scope":"完整协议：CLI + GitHub Action。本页只演示输出形态，不做强制。","scenario_general":"通用","scenario_code":"代码 / PR","scenario_research":"研究","scenario_production":"生产","btn_sample":"运行样例","btn_review":"真审查","pricing_tag":"定价","pricing_h2":"免费起步，随团队扩展。","pricing_lead":"协议、CLI 与模板为 MIT 开源核心。Team 为托管治理、留存与组织落地 — 不包含协议本身。","price_free_limit":"自托管 · 仓库不限 · BYOK","price_free_who":"适合个人开发者","price_free_1":"CLI + MIT 核心","price_free_2":"本地审查，自带 API key","price_free_3":"OSS 模板 + Action 闸门","price_team_limit":"最多 10 仓库 · 托管工作区 · 90 天留存","price_team_who":"技术负责人审核 AI 生成 PR","price_team_1":"托管组织 policy 与留存","price_team_2":"组织落地与治理控制","price_team_3":"托管 GitHub App（预留）","btn_waitlist":"加入候补","price_ent_label":"定制","price_ent_limit":"SSO/RBAC · 私有化部署 · SLA + 审计陪跑","price_ent_who":"需要私有化部署与审计陪跑的组织","price_ent_1":"私有化部署","price_ent_2":"流程集成","price_ent_3":"审计陪跑","start_tag":"开始","start_h2":"60 秒本地跑起来。","docs_install":"5 分钟安装 GitHub Action →","boundary_tag":"边界","boundary_h2":"Falsify 只做风险分类，不做执行授权。","boundary_p":"真实资金、生产配置、cron、网关与外部发送仍需独立终审。自己审自己不算独立判断。","licensing_tag":"开源核心","licensing_h2":"什么开源，什么归 Team。","licensing_p":"MIT 覆盖协议、CLI、JSON schema、工作流模板与本地产物。Team 覆盖托管 policy 执行、报告留存、组织落地与托管集成 — 不是 OSS 模板的第二份拷贝。","lic_open_1":"协议 + CLI + 模板","lic_open_2":"MIT — 自托管，仓库不限","lic_team_1":"托管治理 + 留存","lic_team_2":"Team — 组织工作区，不与 OSS 重叠","licensing_link":"阅读完整 Open Core 边界 →","btn_github":"GitHub"}};
let lang='en';
