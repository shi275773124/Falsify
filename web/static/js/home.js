...
const T = {
  en: {
    ...
    hero_eyebrow: "Evidence gate · quant · production · AI judgment",
    h1: "Gates green. Live money one step away.",
    hero_sub: "Self-review shares the same blind spot. Cross-vendor attack → exit code + PASS / PASS_WITH_DEBT / BLOCK — machine artifact, not Sharpe theater.",
    ...
    gate_pass: "PASS",
    ev1_val: "exit code",
    ev1_lbl: "0 PASS · 1 debt · 2 BLOCK",
    ev2_val: "3 verdicts",
    ev2_lbl: "PASS / PASS_WITH_DEBT / BLOCK only",
    ev3_val: "Not Sharpe theater",
    ev3_lbl: "Gate pass ≠ evidence · raw artifact required",
    proof_action: "GitHub Action · open core",
    why_now_tag: "Why now",
    why_now: "This page Self-Falsify BLOCK'd its own Sharpe hero — we fixed copy by protocol. We don't sell stories that fail the gate.",
    proof_github: "GitHub",
    ...
    cases_tag: "Cases",
    cases_h2: "What got caught",
    case_illus: "Internal case",
    case1_domain: "Strategy research",
    case1_title: "Caught: fake Sharpe — fictional rebalance mechanic",
    case1_finding: "6/7 gates PASS, then a second AI reran a different mechanic — SR collapsed 4.06 → ≈0.77. Pass is not evidence.",
    case1_link: "01-fictional-horizon-quant-audit.md →",
    case2_domain: "Research ops · fee table",
    case2_findings: "4 findings",
    case2_title: "Caught: four wrong cells in one fee table",
    case2_finding: "No cite per cell — wrong base, flipped sign, wrong row. Not one typo; the whole table is untrusted.",
    case2_link: "comparison case study →",
    case3_domain: "DevOps · deploy",
    case3_title: "Caught: logs green, state unproven",
    case3_finding: "Deploy log treated as acceptance — no read-after-write probe, no rollback command in the chain.",
  ...
  zh: {
    ...
    nav_skills: "技能",
    footer_skills: "Skills",
    hero_eyebrow: "证据门 · 量化 · 生产 · AI 判断",
    h1: "假绿全过，真钱只差一步。",
    hero_sub: "自己审自己看不见盲区。跨厂商对抗审查 → exit code + PASS / PASS_WITH_DEBT / BLOCK — 机器产物，不是 Sharpe 剧场。",
    ...
    ev1_lbl: "0 PASS · 1 debt · 2 BLOCK",
    ev2_val: "3 种裁决",
    ev2_lbl: "PASS / PASS_WITH_DEBT / BLOCK — 仅此三类",
    ev3_val: "不是 Sharpe 剧场",
    ev3_lbl: "关过了 ≠ 证据 · 要 raw artifact",
    proof_action: "GitHub Action · 开源核心",
    why_now_tag: "为何现在",
    why_now: "本页曾 Self-Falsify BLOCK（Sharpe hero 叙事）— 我们按协议改了 copy。不卖未过闸的故事。",
    proof_github: "GitHub",
    ...
    case_illus: "内部案例",
    case1_domain: "策略研究",
    case1_title: "拦住：假 Sharpe — 虚构再平衡机制",
    case1_finding: "6/7 关 PASS 后，第二个 AI 换机制重跑 — SR 从 4.06 崩到 ≈0.77。过关不是证据。",
    case1_link: "01-fictional-horizon-quant-audit.md →",
    case2_domain: "研究运维 · 费率表",
    case2_findings: "4 处发现",
    case2_title: "拦住：一张费率表四格全错",
    case2_finding: "每格无出处 — 基数错、符号反、行选错。不是算错一个数，是整张表不可信。",
    case2_link: "横向对比案例 →",
    case3_domain: "DevOps · 部署",
    case3_title: "拦住：日志绿了，状态未证",
    case3_finding: "部署 log 当验收 — 缺 read-after-write 探针，验收链里没有 rollback 命令。",
    case3_link: "sample-block-report.json →",
    bl_label: "第一层",
    ar_label: "第二层",
    rs_label: "第三层",
