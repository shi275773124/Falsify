...
const T = {
  en: {
    ...
    nav_skills: "Skills",
    nav_rootfix: "ROOTFIX",
    hero_eyebrow: "Open core · decision gate for AI-era work",
    h1: "Looks green isn't proof.",
    hero_sub:
      "Give Falsify a deployment claim, PR summary, or research report. It checks the evidence and returns a reproducible sign-off artifact: PASS, PASS_WITH_DEBT, or BLOCK.",
    hero_io:
      "In: claim + evidence pack · Out: falsify.review.v1 JSON you can keep, diff, and re-run.",
    hero_step_1_k: "Input",
    hero_step_1: " — a deployment claim, PR summary, or research report",
    hero_step_2_k: "Check",
    hero_step_2: " — adversarial evidence review (not self-review)",
    hero_step_3_k: "Artifact",
    hero_step_3: " ? a core PASS / PASS_WITH_DEBT / BLOCK receipt as falsify.review.v1 JSON",
    hero_claiming:
      "Installing a skill is not Claiming Falsify — run the sample or CLI and keep the artifact.",
    ...
    how_summary_hint: "Frame ? Adversarial ? Cutline ? core receipt + domain ceiling",
    how_analogy:
      "Like a hard gate before merge — aimed at decisions and claims, not only code diffs.",
    hero_layers_l1_tag: "Contract",
    hero_layers_l1_map: "Define claim, evidence, authority",
    hero_layers_l2_tag: "Adversarial",
    hero_layers_l2_map: "Hunt the cheapest counterproof",
    hero_layers_l3_tag: "Cutline",
    hero_layers_l3_map: "Must Fix, Known Debt, Delete",
    ...
    cta_boundary: "No pricing table yet. Know what ships today vs what stays Pro.",
    oss_h: "OSS (MIT)",
  ...
  zh: {
    ...
    nav_skills: "技能",
    nav_rootfix: "ROOTFIX",
    hero_eyebrow: "Open core · AI 时代决策闸门",
    h1: "看起来绿了，还不够",
    hero_sub:
      "把部署声明、PR 摘要或研究报告交给 Falsify。它核对证据，返回可复现签收产物：PASS、PASS_WITH_DEBT 或 BLOCK。",
    hero_io: "输入：声明 + 证据包 · 输出：可保留、可 diff、可重跑的 falsify.review.v1 JSON。",
    hero_step_1_k: "输入",
    hero_step_1: " — 部署声明、PR 摘要或研究报告",
    hero_step_2_k: "检查",
    hero_step_2: " — 对抗式证据审查（不是自审）",
    hero_step_3_k: "产物",
    hero_step_3: " \u2014 \u6838\u5fc3 PASS / PASS_WITH_DEBT / BLOCK \u56de\u6267\uff0c\u683c\u5f0f falsify.review.v1 JSON",
    hero_claiming: "安装 skill 不等于做过 Falsify——请跑样例或 CLI，并保留产物。",
    btn_see_proof: "看证据",
    ...
    how_label: "如何裁决",
    how_summary_hint: "\u6846\u67b6 \u2192 \u5bf9\u6297 \u2192 Cutline \u00b7 \u6838\u5fc3\u56de\u6267 + \u9886\u57df\u4e0a\u9650",
    how_analogy: "像合并前的硬闸门 — 对准决策与声明，不只是代码 diff。",
    hero_layers_l1_tag: "契约",
    hero_layers_l1_map: "定义声明、证据与权限",
    hero_layers_l2_tag: "对抗",
    hero_layers_l2_map: "寻找最便宜的反证",
    hero_layers_l3_tag: "裁线",
    hero_layers_l3_map: "必须修、已知债、删除",
    ...
    cta_h2: "先审，再信。",
    cta_boundary: "暂无价格表。先看清今天能拿到什么，Pro 多什么。",
    oss_h: "OSS（MIT）",
