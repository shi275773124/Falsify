...
const T = {
  en: {
    ...
    hero_layers_l3_sub: "No audit bloat",
    ...
    case2_title: "Sharpe 4.06 · 6/7 PASS → NOT_VIABLE",
    case2_finding: "Second AI reran a different rebalance mechanic — SR collapsed to ≈0.77. Gate pass is not evidence.",
    case2_link: "quant audit log →",
  ...
  zh: {
    ...
    hero_layers_l1_map: "框架审找腐烂",
    hero_layers_l2_tag: "对抗",
    hero_layers_l2_map: "对抗审找会死的假设",
    hero_layers_l3_tag: "Cutline",
    hero_layers_l3_map: "Cutline决定现在必须改什么",
    hero_layers_l3_sub: "不过度工程",
    hero_layers_verdicts: "PASS / PASS_WITH_DEBT / BLOCK",
    cases_tag: "案例",
    cases_h2: "盲区被拦住",
    case1_domain: "DevOps · 部署",
    case1_title: "日志绿了 ≠ 状态成立",
    case1_finding: "验收链把部署日志当状态证明 — 缺 read-after-write 探针。",
    case1_link: "sample-block-report.json →",
    case2_domain: "策略研究",
    case2_title: "Sharpe 4.06 · 6/7 PASS → NOT_VIABLE",
    case2_finding: "第二 AI 用不同 rebalance mechanic 重跑 — SR 崩至 ≈0.77。门 PASS 不是证据。",
    case2_link: "量化审计日志 →",
    case3_domain: "研究运维 · 费率表",
    case3_verdict: "4 处拦截",
    case3_title: "一张费率表 4 处定价错误",
    case3_finding: "每格无 cite 不准发 — 基数抄错、符号反了、选错行。冲突写进 log，不静默覆盖。",
    case3_link: "横向对比案例 →",
    bl_label: "第一层",
    ar_label: "第二层",
    rs_label: "第三层",
