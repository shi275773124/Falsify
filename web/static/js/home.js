...
const T = {
  ...
  zh: {
    ...
    hero_definition: "完整 Falsify = 框架审计 + 对抗审查 + Cutline；缺任一层，只是局部审查。",
    btn_install: "安装 GitHub Action",
    btn_run_sample_hero: "运行样例",
    trust_band_github: "GitHub",
    trust_mit: "MIT（核心）",
    trust_byok: "无 Falsify key · BYOK",
    trust_discipline: "Cutline 纪律",
    trust_schema: "falsify.review.v1",
    preview_label: "审查输出",
    ...
    hero_img_alt: "Falsify BLOCK 审查：reports/deploy.md 日志被当作状态验证",
    ...
    case1_link: "sample-block-report.json →",
    case2_domain: "策略研究",
    case2_title: "说明性案例 · Sharpe 4.06 · 6/7 PASS → NOT_VIABLE",
    case2_finding: "已发布案例 — 第二 AI 用不同再平衡机制重跑，SR 崩至 ≈0.77。PASS 本身不是证据。",
    case2_link: "examples/real-cases/01-fictional-horizon-quant-audit.md →",
    case3_domain: "研究运维 · 费率表",
    case3_verdict: "4 处拦截",
    case3_title: "一张费率表 4 处定价错误",
    case3_finding: "每格缺出处，不准发布 — 基数抄错、符号反了、选错行。冲突写进 log，不静默覆盖。",
    case3_link: "横向对比案例 →",
    bl_label: "第一层",
    ar_label: "第二层",
    rs_label: "第三层",
    ...
    artifact_lead: "协议样例 JSON — 不是伪造的 GitHub Check 截图。",
