...
const T = {
  en: {
    ...
    quote_p: "Just as Bitcoin lets you accept payment without trusting the payer, Falsify lets you accept a conclusion without trusting the model — because that conclusion has already survived the attack.",
    ...
    licensing_p: "MIT covers the protocol, CLI, JSON schema, workflow templates, and local artifacts.",
  ...
  zh: {
    ...
    quote_p: "正如比特币让你无需信任付款人即可接受支付，Falsify 让你无需信任模型即可接受它的结论——这个结论，已经活过了攻击。",
    quote_cite: "Chris Shi",
    ...
    licensing_p: "MIT 覆盖协议、CLI、JSON schema、工作流模板与本地产物。",
