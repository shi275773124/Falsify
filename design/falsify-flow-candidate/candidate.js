(() => {
  ...
  const translations = {
    en: {
      ...
      d1Name:"Falsify Review",d1Status:"AVAILABLE · OSS",d1Text:"Adversarial LLM review with a bounded epistemic verdict. CLI, local demo, skills, DeepSeek plugin, and the GitHub Action template.",
    ...
    zh: {
      ...
      d1Name:"Falsify Review",d1Status:"AVAILABLE · 开源",d1Text:"对抗式 LLM 审查，签发边界内的认知层裁决。含 CLI、本地 demo、skills、DeepSeek 插件与 GitHub Action 模板。",
